...
setcookie('Person_ID','10');     // Hard Coding cookie values for temporary basis
...
$query = "select photo from person where person_id = '$Person_ID'";
$result = mysql_query($query);
while($row = mysql_fetch_array($result)) {
$picpath = $row['photo'];
}
...
<tr>
  <td>
    <img src="<?php echo $picpath ?>" style="width:300px;height:300px">
    </td>
  </tr>
</table>
</div>
...
<tr>
      <td>
        <label for="textfield"><strong>Comments: </strong></label>
      </td>
</tr>
<tr>      
<td >
...
<?php
//echo $Person_ID;
$conne=mysqli_connect("localhost","root","","alumnidb2");
$sql = "SELECT * FROM upload_info where Receiving_Person_Id = $Person_ID"; 
...
?>    
      ...
      <img src ="<?php echo $upload_pic; ?>" height = 100 width = 100 >
