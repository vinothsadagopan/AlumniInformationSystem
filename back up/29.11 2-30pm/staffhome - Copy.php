			...
			<div id="main">
				<form  name="approveregistration" action="staffhome.php" method="POST">
					...
					<tr id="header">
						...
						<td><input type="submit" name="<?php echo $str; ?>" value="accept <?php echo $str ?>">
						<!--<input type = "hidden" name = "<?php echo $str?>" value ="<?php echo $str?>"--></td>
						</tr>
						<?php 
						$value = $_POST[$str];
						echo $value;
						//$sql = "UPDATE Person SET Reg_flag=1 where F_Name='$firstname' and L_Name='$lastname' ";
						//echo $sql;
						//$r = mysql_query ($sql);
